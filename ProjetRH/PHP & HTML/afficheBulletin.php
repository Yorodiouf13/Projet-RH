...
if (isset($_GET['idEmp'])) {
  ...
  $reponse = $bdd->query("SELECT employe.*, salaire.*, contrat.* FROM employe left JOIN salaire on employe.idEmp=salaire.emp_sal right join contrat on employe.idEmp=contrat.emp_contrat  where employe.idEmp = '$idEmp'  AND  salaire.idSalaire = '$idSalaire' AND contrat.idContrat = '$idContrat'  ");
           
           while($utilisateur = $reponse->fetch())
            { 
              
              $utilisateur['plafond']=360000;
              $utilisateur['plafond2']=1080000;
...
<body >
 ...
 <th colspan="4">
        ...
        Nombre de part :<?=$utilisateur['nbrPart']?>
      </th>
...
<button class="btn btn-primary"class="hidden-print" id="btnPrint" style="position: relative; left: 45%;"> <i class='bx bx-printer'></i> Imprimer Ici</button>

<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.2/html2pdf.bundle.js"></script>
<script>
   var btnPrint = document.querySelector('#btnPrint');
    btnPrint.addEventListener("click", () => {
        // Utilisez la bibliothèque html2pdf pour générer un PDF de la partie spécifique de la page et l'imprimer
